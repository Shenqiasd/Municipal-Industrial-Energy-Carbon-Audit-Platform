...
-- Map existing Chinese labels to standard dictionary codes
UPDATE de_ghg_emission SET emission_type = 'DIRECT_COMBUSTION'    WHERE emission_type = '化石燃料燃烧直接排放';
UPDATE de_ghg_emission SET emission_type = 'DIRECT_COMBUSTION'    WHERE emission_type = '直接排放';
...
UPDATE de_ghg_emission SET emission_type = 'INDIRECT_ELECTRICITY' WHERE emission_type = '间接排放';
