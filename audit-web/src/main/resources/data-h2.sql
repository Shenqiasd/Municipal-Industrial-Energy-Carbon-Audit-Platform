...
INSERT INTO de_energy_balance (enterprise_id, audit_year, energy_id, energy_name, measurement_unit, purchase_amount, consumption_amount, create_by, update_by)
VALUES (1, 2024, 1, '电力', '万千瓦时', 5000.0, 4800.0, 'system', 'system');
INSERT INTO de_energy_balance (enterprise_id, audit_year, energy_id, energy_name, measurement_unit, purchase_amount, consumption_amount, create_by, update_by)
VALUES (1, 2024, 2, '天然气', '万立方米', 200.0, 195.0, 'system', 'system');
INSERT INTO de_energy_balance (enterprise_id, audit_year, energy_id, energy_name, measurement_unit, purchase_amount, consumption_amount, create_by, update_by)
VALUES (1, 2024, 3, '原煤', '吨', 10000.0, 9500.0, 'system', 'system');
INSERT INTO de_energy_balance (enterprise_id, audit_year, energy_id, energy_name, measurement_unit, purchase_amount, consumption_amount, create_by, update_by)
VALUES (1, 2024, 4, '蒸汽', '吉焦', 15000.0, 14200.0, 'system', 'system');
INSERT INTO de_energy_balance (enterprise_id, audit_year, energy_id, energy_name, measurement_unit, purchase_amount, consumption_amount, create_by, update_by)
VALUES (1, 2024, 5, '柴油', '吨', 50.0, 48.0, 'system', 'system');
...
INSERT INTO de_product_unit_consumption (enterprise_id, audit_year, product_id, year_type, measurement_unit, output, energy_consumption, unit_consumption, create_by, update_by)
VALUES (1, 2024, 1, '审计年', '吨', 12000.0, 8500.0, 0.7083, 'system', 'system');
INSERT INTO de_product_unit_consumption (enterprise_id, audit_year, product_id, year_type, measurement_unit, output, energy_consumption, unit_consumption, create_by, update_by)
VALUES (1, 2024, 1, '上年度', '吨', 11500.0, 8800.0, 0.7652, 'system', 'system');
INSERT INTO de_product_unit_consumption (enterprise_id, audit_year, product_id, year_type, measurement_unit, output, energy_consumption, unit_consumption, create_by, update_by)
VALUES (1, 2024, 2, '审计年', '吨', 8000.0, 5200.0, 0.6500, 'system', 'system');
INSERT INTO de_product_unit_consumption (enterprise_id, audit_year, product_id, year_type, measurement_unit, output, energy_consumption, unit_consumption, create_by, update_by)
VALUES (1, 2024, 2, '上年度', '吨', 7500.0, 5100.0, 0.6800, 'system', 'system');
